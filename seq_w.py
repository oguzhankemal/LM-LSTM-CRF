...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_arg', default='D:/PythoProjects/Datasets/checkpoint/ner/ner_4_cwlm_lstm_crf.json', help='path to arg json')
    parser.add_argument('--load_check_point', default='D:/PythoProjects/Datasets/checkpoint/ner/ner_4_cwlm_lstm_crf.model', help='path to model checkpoint file')
