...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint', default='D:/PythoProjects/Datasets/checkpoint/ner_tr_', help='checkpoint path')
    ...
    parser.add_argument('--load_check_point', default='D:/PythoProjects/Datasets/checkpoint/ner_tr_cwlm_lstm_crf.model', help='path previous checkpoint that want to be loaded')
