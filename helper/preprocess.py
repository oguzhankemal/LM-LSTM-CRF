...
dir = "D:/PythoProjects/Datasets/TezDatasets/NERResources_tobe_Distributed"
# Read parameters from command line
optparser = optparse.OptionParser()
optparser.add_option(
    "-m", "--muc", default="D:/PythoProjects/Datasets/TezDatasets/NERResources_tobe_Distributed/WFS7with[p5].MUClabeled",
...
with open(opts.muc, "r", encoding="utf8") as muc, open("WFS7with[p5].txt", "w+", encoding="utf8") as conll:
    numb_named_entity = 0
    numb_handle = 0
    numb_token = 0
    numb_person_token = 0
